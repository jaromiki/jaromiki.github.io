...
function ghmxy_sendview() {
	if (typeof ghmxy_view != "undefined" && ghmxy_view && typeof encodeURIComponent != 'undefined') {
		...
		ghmxy_viewurl = ghmxy_proto+ghmxy_hitcollector+"/_"+(new Date()).getTime()+"/redot.gif?l=4&w=hview&id="+ghmxy_identifier+"&arg=0&fr="+f+"&href="+encodeURIComponent(href.substring(0,499))+"&ref="+encodeURIComponent(ref.substring(0,499))+"&extra="+encodeURIComponent(extra.substring(0,1999));
		ghmxy_viewimage = new Image();
		ghmxy_viewimage.src = ghmxy_viewurl;
		ghmxy_images[ghmxy_images.length] = ghmxy_viewimage;
	}
}
