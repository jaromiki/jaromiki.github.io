...
begin
  ...
  glBegin(GL_POLYGON);    //zed
    ...
    glTexCoord2f(9,0);    glVertex3f(0,0,0);
    glTexCoord2f(9,2);    glVertex3f(0,2,0);
    glTexCoord2f(0,2);    glVertex3f(10,2,0);
  glEnd;

  LoadBitmap(Path + 'obr1.bmp');
  glTexImage2d(GL_Texture_2D,0,3,Velikost,Velikost,0,GL_RGB,GL_Unsigned_byte,@buffer);
  glBegin(GL_POLYGON);    //zed
    glTexCoord2f(0,0);    glVertex3f(10,0,5);
    glTexCoord2f(9,0);    glVertex3f(0,0,5);
    glTexCoord2f(9,2);    glVertex3f(0,2,5);
    glTexCoord2f(0,2);    glVertex3f(10,2,5);
  glEnd;

  LoadBitmap(Path + 'wall.bmp');
  glTexImage2d(GL_Texture_2D,0,3,Velikost,Velikost,0,GL_RGB,GL_Unsigned_byte,@buffer);
  glBegin(GL_POLYGON);    //zed
    glTexCoord2f(4,2);    glVertex3f(10,0,5);
    glTexCoord2f(0,2);    glVertex3f(10,0,0);
    glTexCoord2f(0,0);    glVertex3f(10,2,0);
    glTexCoord2f(4,0);    glVertex3f(10,2,5);
  glEnd;

  LoadBitmap(Path + 'wall.bmp');
  glTexImage2d(GL_Texture_2D,0,3,Velikost,Velikost,0,GL_RGB,GL_Unsigned_byte,@buffer);
  glBegin(GL_POLYGON);    //zed
    glTexCoord2f(4,2);    glVertex3f(0,0,5);
    glTexCoord2f(0,2);    glVertex3f(0,0,0);
    glTexCoord2f(0,0);    glVertex3f(0,2,0);
    glTexCoord2f(4,0);    glVertex3f(0,2,5);
  glEnd;

  LoadBitmap(Path + 'floor.bmp');
  glTexImage2d(GL_Texture_2D,0,3,Velikost,Velikost,0,GL_RGB,GL_Unsigned_byte,@buffer);
  glBegin(GL_POLYGON);  //podlaha
    glTexCoord2f(3,6);    glVertex3f(10,0,0);
    glTexCoord2f(3,0);    glVertex3f(0,0,0);
    glTexCoord2f(0,0);    glVertex3f(0,0,5);
    glTexCoord2f(0,6);    glVertex3f(10,0,5);
  glEnd;
  ...
  glBegin(GL_POLYGON);  //strop
    glTexCoord2f(0,0);   glVertex3f(10,2,0);
    glTexCoord2f(9,0);   glVertex3f(0,2,0);
    glTexCoord2f(9,2);   glVertex3f(0,2,5);
    glTexCoord2f(0,2);   glVertex3f(10,2,5);
  glEnd;
  glEndList
