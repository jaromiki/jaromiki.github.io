...
var r,g,b:real;
begin
   r:=TrackBar1.Position/100;
   g:=TrackBar2.Position/100;
//   b:=TrackBar3.Position/100;
   fogColor[1]:=r; fogColor[2]:=g; fogColor[3]:=b;
   glFogfv(GL_FOG_COLOR, @fogColor);
   glFogf(GL_FOG_DENSITY, 1.0); // hustota mlhy
   glHint(GL_FOG_HINT, GL_DONT_CARE);
   glFogf(GL_FOG_START, 0.0); // pouzito pro linearni funkci, tady zbytecne
   glFogf(GL_FOG_END, 5.0);
   glclearColor(r,g,b,1.0); // pouzijeme barvu mlhy pro
end;
end.
